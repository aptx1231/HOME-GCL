...
class AbstractExecutor(object):
    ...
    def __init__(self, config, model, data_feature):
        ...
        self.out_lap_mx = self.data_feature.get('out_lap_mx')
        self.in_lap_mx = self.data_feature.get('in_lap_mx')
        self.outdegree = self.data_feature.get('outdegree')
        self.indegree = self.data_feature.get('indegree')
